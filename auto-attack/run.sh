...
cd /projects/p32013/DNABERT-meta/auto-attack
...
for task in "${tasks[@]}"; do
    python auto_new.py --data_dir /projects/p32013/DNABERT-meta/GUE/${task} \
                ...
                --output_dir /projects/p32013/DNABERT-meta/auto-attack/results \
                --model_type bert
