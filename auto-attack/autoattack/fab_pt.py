...
class FABAttack_PT(FABAttack):
    ...
    def _predict_fn(self, x, attention_mask=None, token_type_ids=None):
        return self.predict(inputs_embeds=x, attention_mask=attention_mask, token_type_ids=token_type_ids).logits
    ...
    def get_diff_logits_grads_batch(self, imgs, la, attention_mask=None, token_type_ids=None):
        im = imgs.clone().requires_grad_()
        with torch.enable_grad():
            y = self.predict(inputs_embeds=im, attention_mask=attention_mask, token_type_ids=token_type_ids).logits
    ...
    def get_diff_logits_grads_batch_targeted(self, imgs, la, la_target, attention_mask=None, token_type_ids=None):
